...
from teleoperation.cameras.factory import make_cameras_from_configs
from teleoperation.robot.motor_factory import get_motor_names, make_motors_buses_from_configs
from teleoperation.robot.config import PiperRobotConfig
from teleoperation.utils.robot_devices import RobotDeviceAlreadyConnectedError, RobotDeviceNotConnectedError
...
class PiperRobot:
    def __init__(self, config: PiperRobotConfig | None = None, **kwargs):
        ...
        if self.multi_arm_mode or self.passive_recording_mode:
            ...
            raise RuntimeError(
                "This standalone collector includes passive Piper recording only. "
                "Set passive_recording=true in the robot config."
            )
        else:
            self.teleop = None
    ...
    def _single_arm_gamepad_step(
        ...
        raise RuntimeError("Single-arm gamepad control is not included in this standalone collector.")
